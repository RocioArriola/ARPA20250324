...
public partial class Test20250324DbContext : DbContext
{
    ...
    protected override void OnModelCreating(ModelBuilder modelBuilder)
    {
        ...
        {
            entity.HasKey(e => e.Id).HasName("PK__Brands__3214EC07779C2823");
        ...
        {
            entity.HasKey(e => e.Id).HasName("PK__Products__3214EC070352F2D0");
        ...
        {
            entity.HasKey(e => e.Id).HasName("PK__Users__3214EC07E87EAAA6");

            entity.HasIndex(e => e.Email, "UQ__Users__A9D105344E38AF4C").IsUnique();
        ...
        {
            entity.HasKey(e => e.Id).HasName("PK__Warehous__3214EC07C316F1FB");
